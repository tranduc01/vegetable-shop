...
<html lang="en">
    ...
    <body>
        <%
            ...
            String duplicateIDError = (String) request.getAttribute("CHECK_DUPLICATE");
            String checkDate = (String) request.getAttribute("CHECK_DATE");
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Add Product</a>
        ...
        <section class="py-3">
            <div class="container px-4 px-lg-5 my-5 " style="min-height: 700px">
                <h1 class="text-center fw-bolder">Add new product here!</h1>
                <br>
                <div class="row justify-content-center">                    
                    <div class="col-md-5" style="border: 1px solid #ccc; border-radius: 10px;padding: 30px">
                        <form action="MainController" method="POST">

                            <%if (duplicateIDError == null) {
                            %>
                            <div class="mb-3">                                
                                <label for="inputEmail" class="form-label fw-bolder">ProductID</label>
                                <input required="" class="form-control" type="text" name="productID" value="" />                           
                            </div>
                            <%
                            } else {
                            %>
                            <div class="mb-3">                                        
                                <label for="inputEmail" class="form-label fw-bolder">ProductID <span style="color: red;font-size: 15px"><%=duplicateIDError%></span></label>
                                <input required="" class="form-control" type="text" name="productID" value="" />                           
                            </div>
                            <%
                                }
                            ...
                            <div class="mb-3">                                
                                ...
                                <input required="" class="form-control" type="text" name="productName" value="" />                           
                            </div>

                            <div class="mb-3">
                                <label for="inputPhone" class="form-label fw-bolder">Image URL</label>
                                <input required="" class="form-control" type="url" name="image" value="" />                               
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input required="" class="form-control" type="text" name="quantity" value="" />                              
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input required="" class="form-control" type="date" name="importDate" value="" />                              
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="inputPhone" class="form-label fw-bolder">Import Date <span style="color: red;font-size: 15px"> <%=checkDate%> </span> </label>
                                <input required="" class="form-control" type="date" name="importDate" value="" />                              
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input required="" class="form-control" type="date" name="usingDate" value="" />                             
                            </div>
